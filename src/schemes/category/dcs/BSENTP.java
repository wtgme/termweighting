...
public class BSENTP extends TermBasedWeighting {

	public BSENTP(String filePath, String fileName, String outFilePath,
			String outFileName) {
	...
	protected double weightCalculate(Integer key, int label) {
		double balanceEntropy = matrix.getSmoothBalanceEntropy(key);
