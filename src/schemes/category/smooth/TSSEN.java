...
public class TSSEN extends TermBasedWeighting {

	public TSSEN(String filePath, String fileName, String outFilePath,
			String outFileName) {
	...
	protected double weightCalculate(Integer key, int label) {
		double smoothEntropy = matrix.getTSSmoothEntropy(key);
