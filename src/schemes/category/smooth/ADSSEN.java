...
public class ADSSEN extends TermBasedWeighting {

	public ADSSEN(String filePath, String fileName, String outFilePath,
			String outFileName) {
	...
	protected double weightCalculate(Integer key, int label) {
		double smoothEntropy = matrix.getADSmoothEntropy(key);
