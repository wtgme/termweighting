...
public class LapSEN extends TermBasedWeighting {

	public LapSEN(String filePath, String fileName, String outFilePath,
			String outFileName) {
	...
	protected double weightCalculate(Integer key, int label) {
		double smoothEntropy = matrix.getLapSmoothEntropy(key);
