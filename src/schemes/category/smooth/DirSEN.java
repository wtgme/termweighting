...
public class DirSEN extends TermBasedWeighting {

	public DirSEN(String filePath, String fileName, String outFilePath,
			String outFileName) {
	...
	protected double weightCalculate(Integer key, int label) {
		double smoothEntropy = matrix.getDirSmoothEntropy(key);
